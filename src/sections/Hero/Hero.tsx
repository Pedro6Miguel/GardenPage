...
export const Hero = () => {
  return (
    <div>
        ...
        <div className='absolute top-[36%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-[-1]'>
            <h1 className='text-center text-dark leading-tight max-[930px]:w-[80vw] max-[580px]:text-[48px] max-[418px]:text-[42px] max-[418px]:w-[90vw]'>Nature's Beauty Delivered to You</h1>
